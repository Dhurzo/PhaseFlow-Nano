...
4. Write state update (`.phase` file) and summary files (`SUMMARY.md`, `CONTEXT.md`, `DECISIONS.md`)
   ⚠️ The agent does NOT edit `plan.md`'s phase table — it is a derived view regenerated by `phaseflow-doctor --fix`.
